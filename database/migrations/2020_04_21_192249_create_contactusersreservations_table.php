...
class CreateContactusersreservationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contactusersreservations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('contactusersreservations');
    }
}
