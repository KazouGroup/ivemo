...
Vue.filter('formatSlug', function (value) {
    if (value) {
...
Vue.component('navhorizontal-premium', require('./components/inc/PremiumHorizontalNavUserSite').default);
Vue.component('navertical-premium', require('./components/inc/PremiumVerticalNavUserSite').default);
 ...
 */
if (document.getElementById('app_ivemo') !== null){
    const app_ivemo = new Vue({
        el: '#app_ivemo',
        router,
