    ...
    <div v-if="$auth.can('manage-signal')" class="main-panel" id="main-panel">
        ...
        <div class="panel-header">
            <div class="header text-center">
                <h2 class="title">Annonces reservations signaler</h2>
            </div>
        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr v-for="item in signalannoncereservations" :key="item.id"  v-if="item.signalannoncereservations_count > 0">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <router-link :to="{ name: 'signalannoncereservations.show', params: { annoncereservation: item.slug  } }" class="btn btn-info btn-icon btn-sm ">
...
<script>
    ...
    export default {
        data() {
            document.title = `Dashboard annonces reservations signalées  - Ivemo`;
            return {
                page: 1,
