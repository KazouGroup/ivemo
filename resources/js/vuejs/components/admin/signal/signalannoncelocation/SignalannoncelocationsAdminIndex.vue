                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr v-for="item in signalannoncelocations" :key="item.id"  v-if="item.signalannoncelocations_count > 0">
                                            ...
                                            <td class="text-center">
                                                {{item.signalannoncelocations_count}}
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <router-link :to="{ name: 'signalannoncelocations.show', params: { annoncelocation: item.slug  } }" class="btn btn-info btn-icon btn-sm ">
    ...
    export default {
        ...
        methods:{
            ...
            activeItem(id) {
                //Progress bar star
                this.$Progress.start();
                dyaxios.get(route('activated_signalannoncelocations',id)).then(() => {
            ...
            disableItem(id) {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get(route('unactivated_signalannoncelocations',id)).then(() => {
                    /** Alert notify bootstrapp **/
                    $.notify(
                        {
