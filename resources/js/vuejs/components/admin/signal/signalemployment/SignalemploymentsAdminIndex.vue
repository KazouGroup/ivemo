                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                          <table class="table">
                            ...
                            <tbody>
                              <tr
                                v-for="item in signalannonceventes"
                                :key="item.id"
                                v-if="item.signalannonceventes_count > 0"
                              >
...
export default {
  ...
  methods: {
    ...
    activeItem(id) {
      ...
      this.$Progress.start();
      dyaxios
        .get(route("activated_signalannonceventes", id))
        .then(() => {
    ...
    disableItem(id) {
      ...
      this.$Progress.start();
      dyaxios
        .get(route("unactivated_signalannonceventes", id))
        .then(() => {
          /** Alert notify bootstrapp **/
          $.notify(
            {
    ...
    infiniteHandler($state) {
      dyaxios
        .get(route("api.signalannonceventes"), {
          params: {
            page: this.page
          }
        })
