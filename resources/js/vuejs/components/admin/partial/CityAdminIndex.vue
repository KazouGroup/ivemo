    ...
    <div class="main-panel" id="main-panel">
        ...
        <div class="panel-header">
            <div class="header text-center">
                <h2 class="title">Cities {{ country }}</h2>
                <p class="text-white">All cities are
                    <a href="#"><b>{{ cities.length }}</b></a></p>
            </div>
        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h6 v-show="!editmode" class="modal-title" id="addNewLabel"><b>Add City {{ country }}</b></h6>
...
<script>
    ...
    export default {
        data() {
            document.title = `Dashboard Cities - Ivemo`;
            return {
                cities: {},
                editmode: false,
                form: new Form({
