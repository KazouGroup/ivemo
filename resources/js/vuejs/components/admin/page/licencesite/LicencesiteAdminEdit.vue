                                ...
                                <form id="RegisterValidation" @submit.prevent="updateItem()" role="form"
                                    ...
                                    <div class="submit">
                                        <div class="text-center">
                                            <router-link :to="{ name: 'licencesites.index' }" class="btn btn-secondary btn-raised">
...
<script>
    export default {
        data() {
            document.title = `Licence site ${this.user.first_name || this.name_site} - ${this.name_site}`;
            return {
                user: {},
                form: new Form({
                    id: '',
        ...
        methods: {
            ...
            updateItem() {
                ...
                this.form.put(route('licencesites.update',[this.form.id]))
                    .then(() => {
        ...
        mounted() {
            ...
            dyaxios.get(route('licencesites.show',[ID])).then(({data}) => {
                this.loaded = true;
                this.form.fill(data);
            });
            this.$Progress.finish();
