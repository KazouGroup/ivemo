                            ...
                            <div :class="getColorHeaderUser()">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="card-title">Licence site</p>
                                    </div>
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tr v-for="item in licencesites" :key="item.id">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <router-link :to="{ name: 'licencesites.edit', params: { id: item.id  } }" title="Editer" class="btn btn-info btn-sm btn-just-icon">
...
<script>
    ...
    export default {
        ...
        data() {
            document.title = `Dashboard Licence site ${this.user.first_name || this.name_site} - ${this.name_site}`;
            return {
                loaded: false,
                licencesites: {},
            }
            ...
            deleteItem(item){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        let index = this.licencesites.indexOf(item);
                        this.licencesites.splice(index, 1);

                        //Envoyer la requete au server
                        let url = route('licencesites.destroy',item.id);
