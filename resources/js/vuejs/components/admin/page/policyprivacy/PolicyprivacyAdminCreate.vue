                        ...
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="card-title">
                                            <b>{{this.form.title || "New Policy privacy"}}</b>
                                        </h4>
                                        <p class="card-title">{{this.form.title || "New Policy privacy"}}</p>
                                    </div>
...
<script>
    export default {
        data() {
            document.title = `New Policy privacy ${this.user.first_name || this.name_site} - ${this.name_site}`;
            return {
                user: {},
                form: new Form({
                    id: '',
        ...
        methods: {
            createItem() {
                ...
                this.form.post(route('policyprivacies.store'))
                    .then(() => {
