    ...
    <div class="main-panel" id="main-panel">
        ...
        <div class="panel-header">
            <div class="header text-center">
                <h2 class="title">Edition Policy privacy</h2>
                        ...
                        <div class="card-body">
                            <div class="toolbar">
                                <div class="submit text-center">
                                    <router-link :to="{ name: 'policyprivacies.create' }" class="btn btn-round btn-primary btn-raised">
...
<script>
    export default {
        data() {
            document.title = `Policy privacy - Ivemo`;
            return {
                categories_faqs: {},
                user: {},
                form: new Form({
