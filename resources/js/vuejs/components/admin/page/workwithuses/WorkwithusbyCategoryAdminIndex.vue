                        ...
                        <div class="card card-stats">
                            <div :class="getColorCardUser()">
                                ...
                                <p class="card-category">
                                    <b>{{workwithusesbyc.name}}</b>
                                </p>
                                <h3 class="card-title" style="color:red;">
                                    <b>{{workwithusesbyc.workwithuses.length}}</b>
                                </h3>
                            </div>
                            ...
                            <div :class="getColorHeaderUser()">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="card-title">{{workwithusesbyc.name}}</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="toolbar">
                                    ...
                                    <div class="submit text-center">
                                        ...
                                        <router-link v-if="$auth.can('manage-rh')" :to="{ name: 'workwithuses.create' }" class="btn btn-primary btn-raised">
                                      <span class="btn-label">
                                ...
                                <div class="material-datatables">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tr v-for="(item,index) in workwithusesbyc.workwithuses" :key="item.id">
                                            ...
                                            <td v-text="item.categoryworkwithus.name"></td>
    ...
    export default {
        ...
        methods:{
            ...
            loadItems() {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get(route('api.work_with_uscategoryworkwithus_dashboard',this.$route.params.categoryworkwithus)).then(response => {
                    this.loaded = true;
