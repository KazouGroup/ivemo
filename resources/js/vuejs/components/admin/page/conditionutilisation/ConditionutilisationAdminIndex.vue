                        ...
                        <div class="card">
                            <div :class="getColorHeaderUser()">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="card-title">
                                            <b>Condition utilisation</b>
                                        </h4>
                                        <p class="card-title">Condition utilisation</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="toolbar">
                                    <div class="submit text-center">
                                        <router-link :to="{ name: 'conditionutilisations.create' }" class="btn btn-primary btn-raised">
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tr v-for="item in conditionutilisations" :key="item.id">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <router-link :to="{ name: 'conditionutilisations.edit', params: { id: item.id  } }" title="Editer" class="btn btn-info btn-sm btn-just-icon">
