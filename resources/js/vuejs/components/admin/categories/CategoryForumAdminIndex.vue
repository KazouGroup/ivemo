                        ...
                        <div class="card card-stats">
                            <div :class="getColorCardUser()">
                                ...
                                <p class="card-category">
                                    <b>Categories forums</b>
                                </p>
                                <h3 class="card-title" style="color:red;">
                                    <b>{{categoryforums.length}}</b>
                                </h3>
                            </div>
                            ...
                            <div :class="getColorHeaderUser()">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="card-title">Categories forum</p>
                                    </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="submit text-center">
                                        <button v-if="$auth.can('manage-categories')" class="btn btn-primary btn-raised " @click="newModal">
                                           <span class="btn-label">
                                            ...
                                            <b class="title_hover">New Category on forum</b>
                                        </button>
                                    </div>
                                ...
                                <div class="material-datatables">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tbody>
                                        <tr v-for="item in categoryforums" :key="item.id">
                                            ...
                                            <td>
                                                <div class="timeline-heading">
                                                    ...
                                                    <span v-else  class="badge badge-rose"><b>Deactive</b></span>
                                                </div>
                                            </td>
                                            <td><b>{{ item.forums_count }}</b></td>
...
<script>
    ...
    export default {
        ...
        data() {
            document.title = `Dashboard Categories forums ${this.user.first_name || this.name_site} - ${this.name_site}`;
            return {
                editmode: false,
                loaded: false,
                categoryforums: {},
        ...
        methods:{
            ...
            storeItem() {
                ...
                this.form.post(route('categoryforums.store')).then(() => {
            ...
            updateItem() {
                //Start Progress bar
                this.$Progress.start();
                this.form.put(route('categoryforums.update',this.form.id))
                    .then(() => {
                        //Masquer le modal après la création
                        $('#addNew').modal('hide');
                        //Event
            ...
            activeItem(id) {
                //Progress bar star
                this.$Progress.start();
                dyaxios.get(route('activated_categoryforums',id)).then(() => {
            ...
            disableItem(id) {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get(route('unactivated_categoryforums',id)).then(() => {
                    /** Alert notify bootstrapp **/
                    $.notify(
                        {
            ...
            deleteItem(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        let url = route('categoryforums.destroy',id);
            ...
            loadItems() {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get(route('api.categoryforums')).then(response => {
                    this.loaded = true;
                    this.categoryforums = response.data;
                    this.mydatatables();
                });
                //End Progress bar
                this.$Progress.finish();
