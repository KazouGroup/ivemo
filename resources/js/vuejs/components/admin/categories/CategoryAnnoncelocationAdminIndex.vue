    ...
    <div class="main-panel" id="main-panel">
        ...
        <div class="panel-header">
            <div class="header text-center">
                <h2 class="title">Categories annonces locations</h2>
                <p class="text-white">Toutes les Categories pour l'annonce location créé est de
                    <a href="#"><b>{{ categoryannoncelocations.length }}</b></a></p>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="toolbar">
                                <div class="submit text-center">
                                    <button v-if="$auth.can('manage-categories')" class="btn btn-primary btn-round btn-raised " @click="newModal">
                                        ...
                                        <b class="title_hover">New Category annonce location</b>
                                    </button>
                                </div>
                            </div>
                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr v-for="item in categoryannoncelocations" :key="item.id">
                                    ...
                                    <td>{{ item.annoncelocations_count }}</td>
                                    <td>{{ item.blogannoncelocations_count }}</td>
...
<script>
    ...
    export default {
        data() {
            document.title = `Dashboard Categories annonces locations - Ivemo`;
            return {
