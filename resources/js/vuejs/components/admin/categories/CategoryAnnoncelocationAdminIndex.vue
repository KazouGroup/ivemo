                        ...
                        <div class="card card-stats">
                            <div :class="getColorCardUser()">
                                ...
                                <p class="card-category">
                                    <b>Categories annonces locations</b>
                                </p>
                                <h3 class="card-title" style="color:red;">
                                    <b>{{categoryannoncelocations.length}}</b>
                                </h3>
                            </div>
                            ...
                            <div :class="getColorHeaderUser()">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="card-title">Categories annonces locations</p>
                                    </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="submit text-center">
                                        <button v-if="$auth.can('manage-categories')" class="btn btn-primary btn-raised " @click="newModal">
                                           <span class="btn-label">
                                            ...
                                            <b class="title_hover">New Categories annonces locations</b>
                                        </button>
                                    </div>
                                ...
                                <div class="material-datatables">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tbody>
                                        <tr v-for="item in categoryannoncelocations" :key="item.id">
                                            ...
                                            <td><b>{{ item.blogannoncelocations_count }}</b></td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 v-show="!editmode" class="modal-title" id="addNewLabel"><b>{{this.form.name || "Add Category annonces location"}}</b></h6>
...
<script>
    ...
    export default {
        ...
        data() {
            document.title = `Dashboard Categories annonces locations ${this.user.first_name || this.name_site} - ${this.name_site}`;
            return {
                editmode: false,
                loaded: false,
        ...
        methods:{
            ...
            storeItem() {
                ...
                this.form.post(route('categoryannoncelocations.store')).then(() => {
            ...
            updateItem() {
                //Start Progress bar
                this.$Progress.start();
                this.form.put(route('categoryannoncelocations.update',this.form.id))
                    .then(() => {
                        //Masquer le modal après la création
                        $('#addNew').modal('hide');
                        //Event
            ...
            activeItem(id) {
                //Progress bar star
                this.$Progress.start();
                dyaxios.get(route('activated_categoryannoncelocations',id)).then(() => {
            ...
            disableItem(id) {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get(route('unactivated_categoryannoncelocations',id)).then(() => {
                    /** Alert notify bootstrapp **/
                    $.notify(
                        {
            ...
            deleteItem(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        let url = route('categoryannoncelocations.destroy',id);
            ...
            loadItems() {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get(route('api.category_annonce_locations')).then(response => {
                    this.loaded = true;
                    this.categoryannoncelocations = response.data;
                    this.mydatatables();
                });
                //End Progress bar
                this.$Progress.finish();
