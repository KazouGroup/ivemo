                                ...
                                <div class="card-body">
                                    <div class="toolbar">
                                        <div class="text-center">
                                            <router-link  :to="{ name: 'blogannonceventes.dashboard'}" class="btn btn-secondary btn-raised">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            loadItems(){
                let Itemslug = this.$route.params.categoryannoncevente;
                dyaxios.get(route('api.blogannonceventesbycategory_dashboard_count',[Itemslug])).then(response => {
                    this.blogannonceventes_count = response.data;});

                dyaxios.get(route('api.blogannonceventesbycategory_dashboardactive_count',[Itemslug])).then(response => {
