                ...
                return(
                    <tr key={item.id}>
                        ...
                        <td className="text-right">
                            ...
                            <Link to={`/dashboard/premium/boclair_temgoua_1/teams/${item.id}/edit/`} className="btn btn-info btn-icon btn-sm btn-info btn-round" data-toggle="tooltip" data-placement="bottom" title={`Éditer cette ${item.full_name}`}>
