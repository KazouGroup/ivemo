                            ...
                            <div class="card-body">
                                <div class="toolbar">
                                       <div class="text-right">
                                           ...
                                           <button @click="unactiveItem(form.id)" v-if="form.status" type="button"
                                                   class="btn btn-success btn-just-icon btn-sm"
                                                   title="Desactiver">
                                               <i class="material-icons">remove</i>
                                           </button>
                                           <button @click="activeItem(form.id)" v-else type="button"
                                                   class="btn btn-rose btn-just-icon btn-sm"
                                                   title="Activer">
                                               <i class="material-icons">done</i>
                                           </button>
                                           <button @click="deleteItem(form.id)"
                                ...
                                <div v-if="loaded" class="row">
                                    <div class="col-md-12">
                                        <div class="container">
                                            <div class="row">
                                                <div class="card-body">
                                                    <form id="RegisterValidation" @submit.prevent="saveItem()" role="form"
    ...
    export default {
        ...
        methods:{
            ...
            saveItem() {
                ...
                this.form.put(route('blogannoncecategoryventeupdate_site',[Itemdata]))
                    .then(() => {
