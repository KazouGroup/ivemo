import {
    ...
    ARCHVEMENT_CONTACTSERVICE_ANONCERESERVATION_ADD,
    ARCHVEMENT_CONTACTSERVICE_ANONCERESERVATION_REMOVE,
    FAVORITE_CONTACTSERVICE_ANONCERESERVATION_ADD,
    FAVORITE_CONTACTSERVICE_ANONCERESERVATION_REMOVE,
    ACTIVE_CONTACTSERVICE_ANONCERESERVATION_ADD,
    ACTIVE_CONTACTSERVICE_ANONCERESERVATION_REMOVE,
    DELETE_CONTACTSERVICE_ANONCERESERVATION,
} from "../index";
...
export const activecontactaddItem = id => dispatch => {
    ...
    dyaxios.post(url).then(() => {
            ...
            dispatch({
                type: ACTIVE_CONTACTSERVICE_ANONCERESERVATION_ADD,
                payload: id
            });
        }
...
export const activecontactremoveItem = id => dispatch => {
    ...
    dyaxios.post(url).then(() => {
            ...
            dispatch({
                type: ACTIVE_CONTACTSERVICE_ANONCERESERVATION_REMOVE,
                payload: id
            });
        }
    ).catch(error => console.error(error));
...
export const archvementaddItem = id => dispatch => {
    ...
    dyaxios.post(url).then(() => {
            ...
            dispatch({
                type: ARCHVEMENT_CONTACTSERVICE_ANONCERESERVATION_ADD,
                payload: id
            });
        }
    ).catch(error => console.error(error));
...
export const archvementremoveItem = id => dispatch => {
    ...
    dyaxios.post(url).then(() => {
            ...
            dispatch({
                type: ARCHVEMENT_CONTACTSERVICE_ANONCERESERVATION_REMOVE,
                payload: id
            });
        }
    ).catch(error => console.error(error));
...
export const favoriteaddItem = id => dispatch => {
    ...
    dyaxios.post(url).then(() => {
            ...
            dispatch({
                type: FAVORITE_CONTACTSERVICE_ANONCERESERVATION_ADD,
                payload: id
            });
        }
    ).catch(error => console.error(error));
...
export const favoriteremoveItem = id => dispatch => {
    ...
    dyaxios.post(url).then(() => {
            ...
            dispatch({
                type: FAVORITE_CONTACTSERVICE_ANONCERESERVATION_REMOVE,
                payload: id
            });
        }
    ).catch(error => console.error(error));
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            dyaxios.delete(url).then(() => {
                ...
                dispatch({
                    type: DELETE_CONTACTSERVICE_ANONCERESERVATION,
                    payload: id
                });
