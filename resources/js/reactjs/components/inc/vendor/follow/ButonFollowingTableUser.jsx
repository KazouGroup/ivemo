...
class ButonFollowingTableUser extends PureComponent {
    ...
    render() {
        const {nameununfollower, nameunfollower, followinguser} = this.props;
        return (
            <>
                {$guest ? (
                        <>
                    ...
                    <>
                        {this.props.id !== $userIvemo.id && (
                            <>
                                {followinguser ?
                                    <>
                                        <Button title="Vous me suivez déjà" onClick={() => this.props.unfolloweringForTableItem(this.props)}
                                    ...
                                    <>
                                        ...
                                        <Button onClick={() => this.props.followeringForTableItem(this.props)}
...
export default ButonFollowingTableUser;
