...
class FormCommentContactPivate extends Component {
               ...
               {$guest ?
                   <div className="media media-post">
                       ...
                       <div className="media-body">
                           ...
                           <FieldInput name="message" type='textarea' maxLength="5000" placeholder="Laisser votre message ou un commentaire privé..."  value={value}
...
export default FormCommentContactPivate;
