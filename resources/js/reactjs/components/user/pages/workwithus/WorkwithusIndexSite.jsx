...
import {loadItems} from '../../../../redux/actions/workwithuseActions'
                                ...
                                <div className="row">
                                    <div className="col-md-10 mx-auto">
                                        ...
                                        <h5 className="text-center description">
                                            ...
                                            (en) {$country}</b></Link>. Il a été lancé en 2020, dans le but d'offrir la
                                    ...
                                    {workwithuses.length >= 1 && (
                                        ...
                                        <Fragment>
                                            <div className="col-md-10 mx-auto">
                                                ...
                                                <h5 className="text-center description">
                                                    Si vous aimez les défis et souhaitez travailler dans un
...
export default connect(mapStateToProps, {loadItems})(WorkwithusIndexSite);
