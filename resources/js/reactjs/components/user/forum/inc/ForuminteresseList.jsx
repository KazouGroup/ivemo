...
class ForuminteresseList extends Component {
    ...
    getDescription() {
        return { __html: (this.props.description.length > 50 ? this.props.description.substring(0, 50) + "..." : this.props.description) };
    }
    render() {
        return (
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-header d-flex align-items-center">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="mx-3">
                                        <NavLink to={this.props.user.status_profile ? `/pro/${this.props.user.slug}/forums/` : `/user/${this.props.user.slug}/forums/`} className="text-dark font-weight-600 text-sm"><b>{this.props.user.first_name}</b>
                                ...
                                <div className="text-right ml-auto">
                                    <span className="card-title">
                                         <i className="now-ui-icons tech_watch-time"/> {moment(this.props.created_at).fromNow()}
                                    </span>
                                </div>
                            </div>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    {$guest ?
                                        <>
                                            ...
                                            </Button> {this.data_countfavoriteFormatter(this.props.countfavorites)}
                                        </>
...
export default ForuminteresseList;
