...
import {loadCommentsCities,likeItem,unlikeItem,unactiveItem,deleteItem} from "../../../redux/actions/commentsActions";


class CitycommentIndex extends PureComponent {
    constructor(props) {
        super(props);
    ...
    sendresponsecommentItem(e) {
        ...
        let url = route('citysendresponsecomment_site',[itemCity,Id]);
    ...
    sendcommentItem(e) {
        ...
        let itemCity = this.props.match.params.city;
        let url = route('citysendcomment_site',[itemCity]);
        dyaxios.post(url, item)
            .then(() => {
    ...
    updatecommentItem(e) {
        ...
        let itemCity = this.props.match.params.city;
        let Id = this.state.itemData.id;
        let url = route('cityupdatecomment_site', [itemCity,Id]);
    ...
    loadItems() {
        this.props.loadCommentsCities(this.props);
      }
...
CitycommentIndex.propTypes = {
    loadCommentsCities: PropTypes.func.isRequired,
};
...
export default connect(mapStoreToProps, {
    loadCommentsCities,likeItem,unlikeItem,unactiveItem,deleteItem
})(CitycommentIndex);
