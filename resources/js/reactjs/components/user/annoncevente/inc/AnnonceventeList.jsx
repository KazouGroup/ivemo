                    ...
                    <div className="card card-plain card-blog">
                        <div className="row">
                            ...
                            <div className="col-md-7">
                                <div className="card-header d-flex align-items-center">
                                    <div className="text-left pull-left">
                                        <NavLink to={`/annonces_ventes/ventes/${this.props.categoryannoncevente.slug}/`}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-7 col-6">
                                        <NavLink to={`/annonces_ventes/ventes/${this.props.categoryannoncevente.slug}/${this.props.city.slug}/`}>
                                ...
                                <h6 className="card-title">
                                    <Link to={`/annonces_ventes/ventes/${this.props.categoryannoncevente.slug}/${this.props.city.slug}/${moment(this.props.created_at).format('YYYY-MM-DD')}/${this.props.slug}/`}>
                                        {this.props.title}
                                    </Link>
                                </h6>
                                ...
                                <div className="card-header d-flex align-items-center">
                                    ...
                                    <div className="text-right mx-auto">
                                        ...
                                        <NavLink to={`/annonces_ventes/ventes/${this.props.categoryannoncevente.slug}/${this.props.city.slug}/${moment(this.props.created_at).format('YYYY-MM-DD')}/${this.props.slug}/`} className="btn btn-icon btn-sm btn-primary">
