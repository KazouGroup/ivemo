...
class SignalFromAnnonceventeShow extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    signalemessageItem(e) {
        ...
        let url = route('annonceventesignal_site',[itemannoncetype,itemCategoryannoncevente,itemcityannonce,itemannoncevente]);
...
export default SignalFromAnnonceventeShow;
