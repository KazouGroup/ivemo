                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-7">
                                        <div className="card-header d-flex align-items-center">
                                            ...
                                            <div className="text-right ml-auto">
                                                <div className="col-md-12 col-12">
                                                    <h5 className="text-dark"><b>{this.numberWithCommas(this.props)} <small>{$money_country}</small></b></h5>
                                                </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6 col-6">
                                                <NavLink to={`/annonces_locations/locations/${this.props.categoryannoncereservation.slug}/${this.props.city.slug}/`}>
                                        ...
                                        <h6 className="card-title">
                                            <NavLink to={`/annonces_reservations/${this.props.annoncetype.slug}/${this.props.categoryannoncereservation.slug}/${this.props.city.slug}/${this.props.slug}/`}>
                                                {this.props.title}
                                            </NavLink>
                                        </h6>
                                        {/*
                                        ...
                                        <div className="card-header d-flex align-items-center">
                                            <div className="d-flex align-items-center">
                                                <NavLink to={`/pro/${this.props.user.slug}/`}>
                                                    <img src={this.props.user.avatar} style={{ height: "20px", width: "50px" }} alt="" className="avatar" />
                                                </NavLink>
                                                <div className="mx-3">
