...
class BlogannonceventeInteresseList extends PureComponent {
                    ...
                    <div className="card card-blog card-plain">
                        ...
                        <div className="card-body">
                            <div className="text-center">
                                <a target="_blank"
                                   href={`${route('blogannoncecategoryvente_site', this.props.categoryannoncevente.slug)}`}
                                        ...
                                        {($userIvemo.id === this.props.user_id && $userIvemo.id === this.props.user.id) && (
                                            <div className="row">
                                                <div className="mx-auto">
                                                    ...
                                                    <NavLink
                                                        to={`/blogs/annonce_ventes/${this.props.slugin}/edit/`}
                                ...
                                <h6 className="card-title">
                                    <Link className="card-link" to={`/blogs/annonce_ventes/${this.props.categoryannoncevente.slug}/${moment(this.props.created_at).format('YYYY-MM-DD')}/${this.props.slug}/`}>
                                        {this.props.title}
                                    </Link>
                                </h6>
                            </div>
                            <span
                                dangerouslySetInnerHTML={{__html: (this.props.description.length > 96 ? this.props.description.substring(0, 96) + "<a class='text-dark' target=\"_blank\" href=" + route('blogannoncecategoryventeslug_site', [this.props.categoryannoncevente.slug, moment(this.props.created_at).format('YYYY-MM-DD'), this.props.slug]) + ">...<b>lire plus</b></a>" : this.props.description)}}/>
...
export default BlogannonceventeInteresseList;
