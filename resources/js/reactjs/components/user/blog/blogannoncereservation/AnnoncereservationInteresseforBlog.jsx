                                            ...
                                            <div className="col-md-7">
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6 col-6">
                                                        <h6 className="category text-dark">{annoncereservationsinteresses.pieces} p . {annoncereservationsinteresses.rooms && (<>{annoncereservationsinteresses.rooms} ch</>)}. {annoncereservationsinteresses.surface && (<>{annoncereservationsinteresses.surface} m<sup>2</sup></>)}</h6>
                                                    </div>
                                                    <div className="col-md-6 col-6">
                                                        <NavLink to={`/annonces_reservations/reservations/${item.categoryannoncereservation.slug}/${item.city.slug}/`}>
                                                ...
                                                <h6 className="card-title">
                                                    <NavLink to={`/annonces_reservations/${item.annoncetype.slug}/${item.categoryannoncereservation.slug}/${item.city.slug}/${moment(item.created_at).format('YYYY-MM-DD')}/${item.slug}/`}>
                                                        {item.title}
                                                    </NavLink>
                                                </h6>
