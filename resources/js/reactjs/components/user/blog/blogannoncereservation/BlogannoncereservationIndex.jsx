        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                dyaxios.get(url).then(() => {
                    ...
                    $.notify({
                            message: "Cette annonce a été masquée <a href=\"/profile/"+$userIvemo.slug+"/personal_settings/blogs/annonces_reservations/\" target=\"_blank\" class=\"btn btn-info btn-sm\">Modifier ici</a>",
                            url: "/profile/"+$userIvemo.slug+"/personal_settings/blogs/annonces_reservations/",
                            target: "_blank"
                        },
                        {
                            allow_dismiss: false,
