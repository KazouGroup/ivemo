...
class EmployementBycategoryemployementbycity extends Component {
    ...
    loadItems(){
        ...
        dyaxios.post(route('api.employmentscategorybycity_site',[itemCategoryemployment,itemCity]),{
    ...
    render() {
        const {employments,annoncebycity,categoryemployment,cities} = this.state;
