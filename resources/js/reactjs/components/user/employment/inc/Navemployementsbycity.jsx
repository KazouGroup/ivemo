                                    ...
                                    <Fragment>
                                        {cityemployments.map((item) => (
                                            <tr key={item.id}>
                                                ...
                                                <td className="text-right"> <span>{this.getdataString(item.employments_count)}</span> <span className="ivemoItemsTitle">{item.employments_count > 1 ? "annonces" : "annonce"}</span></td>
                                            </tr>
                                        ))}
                                    </Fragment>
                                    :
