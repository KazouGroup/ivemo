                                                                ...
                                                                <div className="row">
                                                                    <div className="col-md-12">
                                                                        <div id="accordion" role="tablist" aria-multiselectable="true" className="card-collapse">
                                                                            ...
                                                                            <label htmlFor="title">Quelle est le type de bien ?</label>
                                                                            <div className="form-group">
                                                                                <select name={'city_id'} value={this.state.city_id}
                                                                                    className={`form-control`}
                                                                                    id="city_id" onChange={this.handleFieldChange}>
                                                                                    <option value="" disabled>Selectionez votre votre type be bien</option>
                                                    ...
                                                    <div className="card card-plain">
                                                        <div className="card-header" role="tab" id="headingOne">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                <b>Caracteristique du bien uniquement pour (Appartement,Maison,Terrain)</b>
                                                                <i className="now-ui-icons arrows-1_minimal-down"></i>
                                                            </a>
                                                        </div>
                                                                    ...
                                                                    <div className="col-md-12">
                                                                        <div id="accordion" role="tablist" aria-multiselectable="true" className="card-collapse">
                                                                            ...
                                                                            <div className="row">
                                                                                ...
                                                                                <div className="col-md-4 ml-auto mr-auto">
                                                                                    <label htmlFor="Chambres">Pièces (optionnel)</label>
                                                                                    <div className="form-group">
                                                                                        <input id='last_name'
                                                                                            type='text'
                                                                                            className={`form-control ${this.hasErrorFor('last_name') ? 'is-invalid' : ''}`}
                                                                                ...
                                                                                <div className="col-md-4 ml-auto mr-auto">
                                                                                    <label htmlFor="Chambres">Chambres (optionnel)</label>
                                                                                    <div className="form-group">
                                                                                        <input id='email'
                                                                                            type='email'
                                                                                ...
                                                                                <small>*optionnel: les champs ne sont pas obligatoires vous avez le cjoix de le remplire ou pas</small>
                                                                            </div>
                                                                ...
                                                                <div className="card card-plain">
                                                                    ...
                                                                    <div id="collapseAsavoir1" className="collapse" role="tabpanel" aria-labelledby="headingAsavoir1">
                                                                        <div className="card-body text-info">
                                                                            Pour trouver un client rapidement, il est préférable de fixer un prix conforme au marché locatif local.
                                                                        </div>
                                                                    </div>
                                                                </div>
