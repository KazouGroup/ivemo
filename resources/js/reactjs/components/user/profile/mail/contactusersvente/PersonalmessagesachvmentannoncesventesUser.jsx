...
class PersonalmessagesachvmentannoncesventesUser extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    loadItems() {
        ...
        dyaxios.get(route('api.personal_mails_archvement_annonces_ventes.site', [itemuser])).then(response => this.setState({ contactusersventes: response.data, }));
    }
                                    ...
                                    <div className="col-lg-8 col-md-12 mx-auto">
                                        ...
                                        <div className="alert alert-info" role="alert">
                                            <div className="container text-center">
                                                <strong>Messages archivés de vos annonces sur la vente.</strong>
                                            </div>
                                        </div>
...
export default PersonalmessagesachvmentannoncesventesUser;
