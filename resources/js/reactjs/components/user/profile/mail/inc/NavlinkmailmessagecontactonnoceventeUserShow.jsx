                                ...
                                <div id="accordion" role="tablist" aria-multiselectable="true" className="card-collapse">
                                    <div className="card-body">
                                        <table>
                                            <tbody>
                                            <tr>
                                                <td> <NavLink to={`/profile/${usersprofile.slug}/personal_mails/archvement_annonces_ventes/`}>{usersprofile.archvementcontactusersventes_count > 1 ? "Messages archivés" : "Message archivé"}</NavLink></td>
