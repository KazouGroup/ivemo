...
class PublicUserBlogannonceLocation extends Component {
    ...
    loadItems(){
        ...
        dyaxios.get(route('api.profilpublique_articleslocations',[itemuser])).then(response => this.setState({blogannoncelocations: response.data,}));
    ...
    render() {
        const {blogannoncelocations,userPublick} = this.state;
                            ...
                            <div className="content-center">
                                <div className="row">
                                    <div className="col-md-8 ml-auto mr-auto">
                                        <h3 className="title">Toutes les articles locations de {userPublick.first_name}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            <div className="card card-plain">
                                                                <div className="card-header" role="tab" id="headingOne">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                        <b>Article de blog de {userPublick.first_name}</b>
