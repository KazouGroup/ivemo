...
Route::post(
    'annonces_locations/{annoncetype}/{categoryannoncelocation}/{city}/{user:slug}/{annoncelocation}/comments',
    'CommentannoncelocationController@sendcomment'
)->name('annoncelocationsendcomment_site');

Route::put(
    'annonces_locations/{annoncetype}/{categoryannoncelocation}/{city}/{user:slug}/{annoncelocation}/comments/{comment}',
    'CommentannoncelocationController@updatecomment'
)->name('annoncelocationupdatecomment_site');

Route::post(
    'annonces_locations/{annoncetype}/{categoryannoncelocation}/{city}/{user:slug}/{annoncelocation}/comments/{comment}/responses',
